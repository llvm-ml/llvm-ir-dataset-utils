...
OPT_DEFAULT_O3_PASS_LIST = [
    ...
    'LoopSimplifyPass1', 'LCSSAPass1', 'SimplifyCFGPass5', 'InstCombinePass3',
    'LCSSAPass2', 'SROAPass3', 'VectorCombinePass1',
    'MergedLoadStoreMotionPass1', 'GVNPass1', 'SCCPPass1', 'BDCEPass1',
    'InstCombinePass4', 'JumpThreadingPass2', 'CorrelatedValuePropagationPass2',
    'ADCEPass1', 'MemCpyOptPass1', 'DSEPass1', 'LCSSAPass3', 'CoroElidePass1',
    'SimplifyCFGPass6', 'InstCombinePass5', 'CoroSplitPass1',
