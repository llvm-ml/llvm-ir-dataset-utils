...
flags.DEFINE_string('corpus_dir', None, 'The corpus directory to look for build logs in.')

flags.mark_flag_as_required('corpus_dir')

def main(_):
  for build_manifest_file_path in glob.glob(os.path.join(FLAGS.corpus_dir, '*/build_manifest.json')):
